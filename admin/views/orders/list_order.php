...
<table class="table" style="margin-top:8px">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><a style="  text-decoration: none;font-size: 1.3em;color:red;font-weight: 700;"  style="display:<?=$status ==4?'':'none';?>"
                ...
                <td><a style="  text-decoration: none;font-size: 1.3em;font-weight: 700;"  href="?option=order_detail&id=<?=$item['id'];?>" class="edit">Chi tiết đơn hàng
                    </a></td>
                <td><a style="  text-decoration: none;font-size: 1.3em;font-weight: 700;"  target="_blank" href="?option=printorder&id=<?=$item['id'];?>">In đơn hàng </a></td>
            </tr>
            <?php endforeach;?>
        </tbody>
    </table>
