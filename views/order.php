...
?>
<div style="min-height:822px" class="form__wrap">
    <form method="post" onsubmit="return info_order()" class="form-container">
        <p id="error"></p>
        <h2>Thông tin người nhận hàng </h2>
        <div class="row">
                <div class="form-group">
                    <label style="color: #000;" for="">Họ tên </label>
                ...
                <div class="form-group">
                    <label style="color: #000;" for="">Điện thoại </label>
                ...
                <div class="form-group">
                    <label style="color: #000;" for="">Địa chỉ :</label>
                    <textarea  style="height: 50px;" name="address" id="address" rows="3"><?=$member['address'];?></textarea>
                </div>
                <div class="form-group">
                    <label style="color: #000;" for="">Ghi chú :</label>
                    <textarea style="height: 50px;" name="note" id="note" rows="3"></textarea>
                </div>
                <div class="form-group">
                    <label style="color: #000;" for="">Email :</label>
                    <input type="email" name="email" id="email" value="<?=$member['email'];?>">
                </div>
                <div class="form-group">
                    <label style="color: #000;" for="">Chọn hình thức thanh toán </label>
                    <?php 
            ...
            <div class="col l-2 l-o-5 m-2 m-o-5 c-4 c-o-4">
                <div class="form-group">
                    <input type="submit" name="ordersave" id="ordersave" value="Đặt hàng " style="color: #000;">
                </div>
            </div>
        </div>
    </form>
